...
public class Controller {
    ...
    public static ArrayList<String> campers = new ArrayList();
    ...
    public static void processMenuOption(String option) {
        ...
        switch (option.toUpperCase()) {
            case "A":
                capitalizeFirstLetter(CisUtility.getInputString("Enter String"));
                //checkIn();
                break;
            case "B":
                checkOut();
    ...
    public static void checkIn() {
        ...
        while (isPresent) {
            ...
            isPresent = campers.contains(name);
            if (!isPresent) {
                campers.add(name);
                System.out.println("Checkin completed for " + name);
            } else {
                System.out.println("There is someone with this name, please use the last name too");
            }
        }
    }
